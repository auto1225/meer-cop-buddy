...
// Phone project (currently sltxwkdvaapyeosikegj). Keep env-driven for self-hosted migration.
export const SHARED_SUPABASE_URL =
  import.meta.env.VITE_PHONE_SUPABASE_URL || "https://sltxwkdvaapyeosikegj.supabase.co";
export const SHARED_SUPABASE_ANON_KEY =
  import.meta.env.VITE_PHONE_SUPABASE_PUBLISHABLE_KEY ||
