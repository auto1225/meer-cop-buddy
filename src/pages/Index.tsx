...
const Index = () => {
  ...
  // Consider smartphone online if status is 'online' OR if is_monitoring is still true
  // (smartphone may temporarily go to background while monitoring is active)
